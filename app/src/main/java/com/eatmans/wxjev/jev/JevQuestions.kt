...
/**
 * 固定 Jev 题目集, 措辞为校准通过的版本（源头是 tools/jev/questions.py）。
 * 规则: 指令与判据用英文, 聊天内容保留中文。
 * state 的 from 字段取 "me"/"other"。
 */
object JevQuestions {
    ...
    /** 恰好 3 条候选上的 best_reply 排序题（中文候选原样保留）。 */
